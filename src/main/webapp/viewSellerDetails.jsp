...
<p><strong>Bill Date:</strong> ${bill.billDate}</p>
                ...
                <div class="product-list">
                    <h4>Products:</h4>
                    <c:if test="${empty bill.productList}">
    ...
    <div class="product">
        <p><strong>Product Name:</strong> ${product.productName}</p>
                ...
                <p><strong>Number of Packs:</strong> ${product.numberOfPacks}</p>
                <p><strong>Total Price:</strong> ₹${product.totalPrice}</p>
                <p><strong>Owner Profit:</strong> ₹${product.ownerProfit}</p>
                <p><strong>Worker Charges:</strong> ₹${product.workerCharges}</p>
            </div>
</c:forEach>
                </div>
            </div>
